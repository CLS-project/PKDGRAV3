...
pkdOldGravityVeryActive(PKD pkd, int bEwald, int nReps, double fEwCut, double dStep) {
	...
	*/
	for (j=0;j<3;++j) {
	    kdnVActive.r[j] = p[i].r[j];
	    kdnVActive.bnd.fCenter[j] = p[i].r[j];
	    kdnVActive.bnd.fMax[j] = 0;
	    }
	kdnVActive.fSoft2 = p[i].fSoft*p[i].fSoft;
	kdnVActive.mom.m = p[i].fMass;
	kdnVActive.mom.xx = 0;
	kdnVActive.mom.yy = 0;
	kdnVActive.mom.xy = 0;
	kdnVActive.mom.xz = 0;
	kdnVActive.mom.yz = 0;
	kdnVActive.mom.xxx = 0;
	kdnVActive.mom.xyy = 0;
	kdnVActive.mom.xxy = 0;
	kdnVActive.mom.yyy = 0;
	kdnVActive.mom.xxz = 0;
	kdnVActive.mom.yyz = 0;
	kdnVActive.mom.xyz = 0;
	kdnVActive.mom.xxxx = 0;
	kdnVActive.mom.xyyy = 0;
	kdnVActive.mom.xxxy = 0;
	kdnVActive.mom.yyyy = 0;
	kdnVActive.mom.xxxz = 0;
	kdnVActive.mom.yyyz = 0;
	kdnVActive.mom.xxyy = 0;
