...
int main(int argc, char **argv) {
    ...
    int bRadFlag = 1; // radiation flag, by default set to 1 = "true", i.e. by default radiation is included
    double z = 0.0;
	...
	static struct option long_options[] = {
	    ...
	    { "redshift",	required_argument, 0, OPT_z},
	    { "radiation", 	required_argument, 0, OPT_rad},
	    { NULL,		0, 0, 0},
	};
	...
	c = getopt_long(argc, argv, "z:r:",long_options, &option_index);
