def parse():
    ...
    imf = parser.add_argument_group('Stellar IMF')
    add_flag(imf,'imftype', dest='achIMFType', help='Type of Initial Mass Function')
    add_flag(imf,'IMFMinMass',default=0.1,dest='dIMFMinMass', help='Lower mass limit of the Initial Mass Function <Mo>')
    add_flag(imf,'IMFMaxMass',default=100.0,dest='dIMFMaxMass', help='Upper mass limit of the Initial Mass Function <Mo>')
