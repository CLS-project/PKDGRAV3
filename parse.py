def parse():
    ...
    add_flag(eeos,'EOSFloorDen',default=1e-5,dest='dEOSFloorDen', type=float, help='Minimum density at which the internal enrgy floor will be applied, n_H cm-3')
    add_flag(eeos,'EOSFloorMinOD',default=10,dest='dEOSFloorMinOD', type=float, help='Minimum density at which the internal enrgy floor will be applied, n_H cm-3')
    add_flag(eeos,'EOSFloorTemp',default=1e4,dest='dEOSFloorTemp', type=float, help='Temperature at the internal energy floor, K')
    add_flag(eeos,'EOSPolyFloornH ',default=0.1,dest='dEOSPolyFloornH', type=float, help='Minimum density at which the effective EOS will be applied (in nH [cm-3])')
