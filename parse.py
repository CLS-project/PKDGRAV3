def parse():
    ...
    add_flag(cool,'CoolingMinOverDensity',default=10.0,dest='dCoolingMinOverDensity', type=float, help='Minimum overdensity at which the internal energy floor will be applied')
    add_flag(cool,'CoolingFloorDen',default=1e-5,dest='dCoolingFloorDen', type=float, help='Minimum density at which the internal energy floor will be applied, n_H cm-3')
    add_flag(cool,'CoolingFloorTemp',default=1e4,dest='dCoolingFloorTemp', type=float, help='Temperature at the internal energy floor, K')

    eeos = parser.add_argument_group('Effective equation of state')
    add_flag(eeos,'EOSMinOverDensity',default=10.0,dest='dEOSMinOverDensity', type=float, help='Minimum overdensity at which the effective EOS will be applied')
