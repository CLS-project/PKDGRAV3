def parse():
    ...
    add_bool(gas,'resmooth',default=True,dest='bConservativeReSmooth',help='Use re-smoothing for the fluxes and gradients computation')
    ...
    sform = parser.add_argument_group('Star formation parameters')
    add_flag(cool,'SFThresholdDen',default=0.1,dest='dSFThresholdDen', type=float, help='Minimum density at which the star formation can happen, nH cm-3')
    add_flag(cool,'SFThresholdT',default=1e5,dest='dSFThresholdT', type=float, help='Maximum temperature at which the star formation can happen, K')
    add_flag(cool,'SFminOverDens',default=57.7,dest='dSFMinOverDensity', type=float, help='Minimum overdensity for allowing star formation')
    add_flag(cool,'SFGasFraction',default=0.3,dest='dSFGasFraction', type=float, help='Gas fraction assumed for the star formation')
    add_flag(cool,'SFindexKS',default=1.4,dest='dSFindexKS', type=float, help='Index of the KS law for star formation')
    add_flag(cool,'SFnormalizationKS',default=2.5e-4,dest='dSFnormalizationKS', type=float, help='Normalization of the KS law for star formation')
    add_flag(cool,'SFEfficiency',default=0.0,dest='dSFEfficiency', type=float, help='Star formation efficiency per free-fall time; set >0 to use density-based SFR')

    snfeed = parser.add_argument_group('Feedback Parameters')
