...
void pstStepVeryActiveHermite(PST pst,void *vin,int nIn,void *vout,int *pnOut) {
	...
	if (pst->iVASplitSide > 0) {
	    ...
	    int rID = mdlReqService(pst->mdl,pst->idUpper,PST_STEPVERYACTIVEH,in,nIn);
	    pstCacheBarrier(pst->pstLower,NULL,0,NULL,NULL);
	    mdlGetReply(pst->mdl,rID,out,NULL);
	    }
	else {
...
void pstCopy0(PST pst,void *vin,int nIn,void *vout,int *pnOut) {
    ...
    if (pst->nLeaves > 1) {
	int rID = mdlReqService(pst->mdl,pst->idUpper,PST_COPY0,in,nIn);
...
void pstPredictor(PST pst,void *vin,int nIn,void *vout,int *pnOut) {
    ...
    if (pst->nLeaves > 1) {
	int rID = mdlReqService(pst->mdl,pst->idUpper,PST_PREDICTOR,in,nIn);
...
void pstCorrector(PST pst,void *vin,int nIn,void *vout,int *pnOut) {
    ...
    if (pst->nLeaves > 1) {
	int rID = mdlReqService(pst->mdl,pst->idUpper,PST_CORRECTOR,in,nIn);
...
void pstSunCorrector(PST pst,void *vin,int nIn,void *vout,int *pnOut) {
    ...
    if (pst->nLeaves > 1) {
	int rID = mdlReqService(pst->mdl,pst->idUpper,PST_SUNCORRECTOR,in,nIn);
...
void pstPredictorInactive(PST pst,void *vin,int nIn,void *vout,int *pnOut) {
    ...
    if (pst->nLeaves > 1) {
	int rID = mdlReqService(pst->mdl,pst->idUpper,PST_PREDICTORINACTIVE,in,nIn);
...
pstAarsethStep(PST pst,void *vin,int nIn,void *vout,int *pnOut) {
    ...
    if (pst->nLeaves > 1) {
	int rID = mdlReqService(pst->mdl,pst->idUpper,PST_AARSETHSTEP,vin,nIn);
...
void pstFirstDt(PST pst,void *vin,int nIn,void *vout,int *pnOut) {
    ...
    mdlassert(pst->mdl,nIn == 0);
    if (pst->nLeaves > 1) {
	int rID = mdlReqService(pst->mdl,pst->idUpper,PST_FIRSTDT,vin,nIn);
...
pstReadSS(PST pst,void *vin,int nIn,void *vout,int *pnOut) {
	...
	rID = mdlReqService(pst->mdl,pst->idUpper,PST_READSS,vin,nIn);
...
pstWriteSS(PST pst,void *vin,int nIn,void *vout,int *pnOut) {
    ...
    if (pst->nLeaves > 1) {
	rID = mdlReqService(pst->mdl,pst->idUpper,PST_WRITESS,vin,nIn);
...
void pstSunIndirect(PST pst,void *vin,int nIn,void *vout,int *pnOut) {
    ...
    if (pst->nLeaves > 1) {
	rID = mdlReqService(pst->mdl,pst->idUpper,PST_SUNINDIRECT,vin,nIn);
...
void pstGravSun(PST pst,void *vin,int nIn,void *vout,int *pnOut) {
    ...
    if (pst->nLeaves > 1) {
	rID = mdlReqService(pst->mdl,pst->idUpper,PST_GRAVSUN,vin,nIn);
...
void pstHandSunMass(PST pst,void *vin,int nIn,void *vout,int *pnOut) {
    ...
    if (pst->nLeaves > 1) {
	rID = mdlReqService(pst->mdl,pst->idUpper,PST_HANDSUNMASS,vin,nIn);
...
pstNextCollision(PST pst,void *vin,int nIn,void *vout,int *pnOut) {
    ...
    if (pst->nLeaves > 1) {
	rID = mdlReqService(pst->mdl,pst->idUpper,PST_NEXTCOLLISION,NULL,0);
...
pstGetColliderInfo(PST pst,void *vin,int nIn,void *vout,int *pnOut) {
    ...
    if (pst->nLeaves > 1) {
	rID = mdlReqService(pst->mdl,pst->idUpper,PST_GETCOLLIDERINFO,vin,nIn);
...
pstDoCollision(PST pst,void *vin,int nIn,void *vout,int *pnOut) {
    ...
    if (pst->nLeaves > 1) {
	rID = mdlReqService(pst->mdl,pst->idUpper,PST_DOCOLLISION,vin,nIn);
...
void pstGetVariableVeryActive(PST pst,void *vin,int nIn,void *vout,int *pnOut) {
    ...
    if (pst->nLeaves > 1) {
	if (pst->iVASplitSide > 0) {
	    rID = mdlReqService(pst->mdl,pst->idUpper,PST_CACHEBARRIER,NULL,0);
	    pstGetVariableVeryActive(pst->pstLower,NULL,0,out,NULL);
	    mdlGetReply(pst->mdl,rID,NULL,NULL);
	    }
	else if (pst->iVASplitSide < 0) {
	    rID = mdlReqService(pst->mdl,pst->idUpper,PST_GETVARIABLEVERYACTIVE,NULL,0);
	    pstCacheBarrier(pst->pstLower,NULL,0,NULL,NULL);
	    mdlGetReply(pst->mdl,rID,out,NULL);
	    }
	else {
...
void pstCheckHelioDist(PST pst,void *vin,int nIn,void *vout,int *pnOut) {
    ...
    mdlassert(pst->mdl,nIn == 0);
    if (pst->nLeaves > 1) {
	rID = mdlReqService(pst->mdl,pst->idUpper,PST_CHECKHELIODIST,vin,nIn);
...
void pstStepVeryActiveSymba(PST pst,void *vin,int nIn,void *vout,int *pnOut) {
	...
	if (pst->iVASplitSide > 0) {
	    ...
	    rID = mdlReqService(pst->mdl,pst->idUpper,PST_STEPVERYACTIVES,in,nIn);
	    pstCacheBarrier(pst->pstLower,NULL,0,NULL,NULL);
	    mdlGetReply(pst->mdl,rID,out,NULL);
	    }
	else {
...
void pstDrminToRung(PST pst,void *vin,int nIn,void *vout,int *pnOut) {
    ...
    mdlassert(pst->mdl,nIn == sizeof(*in));
    if (pst->nLeaves > 1) {
	rID = mdlReqService(pst->mdl,pst->idUpper,PST_DRMINTORUNG,vin,nIn);
...
void pstMomSun(PST pst,void *vin,int nIn,void *vout,int *pnOut) {
    ...
    mdlassert(pst->mdl,nIn == 0);
    if (pst->nLeaves > 1) {
	rID = mdlReqService(pst->mdl,pst->idUpper,PST_MOMSUN,vin,nIn);
...
void pstDriftSun(PST pst,void *vin,int nIn,void *vout,int *pnOut) {
    ...
    if (pst->nLeaves > 1) {
	rID = mdlReqService(pst->mdl,pst->idUpper,PST_DRIFTSUN,vin,nIn);
...
void pstKeplerDrift(PST pst,void *vin,int nIn,void *vout,int *pnOut) {
    ...
    if (pst->nLeaves > 1) {
	rID = mdlReqService(pst->mdl,pst->idUpper,PST_KEPLERDRIFT,vin,nIn);
