...
extern const char *analysis_module_id;
extern const char *bt_c_module_id;
extern const char *bt_h_module_id;
extern const char *cosmo_c_module_id;
extern const char *cosmo_h_module_id;
extern const char *ewald_c_module_id;
extern const char *ewald_h_module_id;
extern const char *meval_h_module_id;
extern const char *qeval_h_module_id;
extern const char *fio_module_id;
extern const char *fio_h_module_id;
extern const char *grav2_c_module_id;
extern const char *grav_h_module_id;
extern const char *grav_c_module_id;
extern const char *grav_h_module_id;
extern const char *ilc_c_module_id;
extern const char *ilc_h_module_id;
extern const char *ilp_c_module_id;
extern const char *ilp_h_module_id;
extern const char *simd_h_module_id;
extern const char *ilp_module_id;
extern const char *intype_c_module_id;
...
extern const char *outtype_c_module_id;
extern const char *outtype_h_module_id;
extern const char *param_c_module_id;
extern const char *param_h_module_id;
extern const char *pkd_module_id;
extern const char *pkd_h_module_id;
extern const char *png_c_module_id;
extern const char *png_h_module_id;
extern const char *psd_module_id;
extern const char *psd_h_module_id;
extern const char *psdtree_module_id;
extern const char *pst_c_module_id;
extern const char *pst_h_module_id;
extern const char *python_c_module_id;
extern const char *python_h_module_id;
extern const char *rbtree_c_module_id;
extern const char *rbtree_h_module_id;
extern const char *romberg_module_id;
extern const char *smooth_module_id;
extern const char *smooth_h_module_id;
extern const char *smoothfcn_c_module_id;
extern const char *smoothfcn_h_module_id;
extern const char *tree_module_id;
extern const char *walk2_module_id;
extern const char *walk_h_module_id;
extern const char *walk2_module_id;
extern const char *walk_c_module_id;
extern const char *walk_h_module_id;
extern const char *collision_c_module_id;
extern const char *collision_h_module_id;
extern const char *kepler_c_module_id;
extern const char *kepler_h_module_id;
extern const char *ssio_c_module_id;
extern const char *ssio_h_module_id;
...
#endif
#ifdef PLANETS
    fprintf(fp, "# %s\n", collision_c_module_id);
    fprintf(fp, "# %s\n", collision_h_module_id);
    fprintf(fp, "# %s\n", kepler_c_module_id);
    fprintf(fp, "# %s\n", kepler_h_module_id);
    fprintf(fp, "# %s\n", ssio_c_module_id);
    fprintf(fp, "# %s\n", ssio_h_module_id);
